...
### Option B — Stack Standard (Recommandée pour la pérennité)

**Technologies :** React + Node.js/Express + PostgreSQL  
**Conteneurisation :** Docker Compose (2 services)

**Avantages :**
- Base de données robuste et pérenne
- Séparation claire des responsabilités
- Facilement extensible (ajout de Redis, d'un reverse proxy, etc.)
- Sauvegarde/restauration PostgreSQL standard

**Inconvénients :**
- Un peu plus complexe à déployer (docker-compose up)
- Nécessite un volume persistant pour Postgres
...
### Option C — Stack Moderne avec BFF (Pour une équipe habituée au JS moderne)

**Technologies :** Next.js (full-stack) + PostgreSQL + Prisma ORM  
**Conteneurisation :** Docker Compose

**Avantages :**
- Un seul framework pour le front et le back
- Prisma ORM : migrations de schéma simplifiées
- SSR pour de meilleures performances initiales

**Inconvénients :**
- Courbe d'apprentissage si l'équipe n'est pas familière avec Next.js
- Build plus lourd
- Moins flexible pour une API REST découplée
...
- Les données doivent **survivre aux redémarrages** du conteneur (volumes Docker)
